...
// new, and existing callers continue to pass `variant="default"` /
// undefined without any surprises.
  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100',
  {
    variants: {
      variant: {
        ...
        // Premium primary CTA — diagonal blue gradient with a glow halo
        // on hover. Use on hero / login / single-call CTAs. Same text
        // contract as `default` so swapping is non-breaking.
        gradient:
        ...
        // Link variant skips the press-scale so inline text doesn't jitter.
