...
// Topbar layout:
//   - Mobile (< md):  [ wordmark ] [ Search icon ] [ NotificationsBell ] [ ThemeToggle ]
...
export function TopBar({ onSearchClick }: { onSearchClick?: () => void }) {
  return (
    <header className="bg-background/80 border-border supports-[backdrop-filter]:bg-background/60 sticky top-0 z-30 flex h-14 items-center gap-3 border-b px-4 backdrop-blur-md md:px-6">
      ...
      {/* Desktop search shell — clicking opens the command palette. */}
      ...
      <div className="flex flex-1 items-center justify-end gap-1 md:flex-none">
        ...
        <button
          ...
          className="text-foreground-72 hover:bg-surface-2 hover:text-foreground focus-visible:ring-ring inline-flex h-9 w-9 items-center justify-center rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 md:hidden"
        >
